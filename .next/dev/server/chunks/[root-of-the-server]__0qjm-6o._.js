...
async function POST(request) {
    try {
        ...
        const { topic, firstName, email, amount } = body;
        if (!stripeSecretKey || !stripeSecretKey.startsWith('sk_test_')) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Stripe sandbox credentials are not configured. Add STRIPE_SECRET_KEY using a test-mode key to enable hosted checkout.'
            }, {
                status: 500
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0qjm-6o._.js.map