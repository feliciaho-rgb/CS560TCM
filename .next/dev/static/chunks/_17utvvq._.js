...
function AdminAppointmentsTable({ appointments }) {
    ...
    const [activeFilter, setActiveFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('pending');
    const filteredRows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminAppointmentsTable.useMemo[filteredRows]": ()=>{
            return rows.filter({
                "AdminAppointmentsTable.useMemo[filteredRows]": (appointment)=>appointment.status === activeFilter
            }["AdminAppointmentsTable.useMemo[filteredRows]"]);
        }
    }["AdminAppointmentsTable.useMemo[filteredRows]"], [
        activeFilter,
...
_s(AdminAppointmentsTable, "2VN8QWe8d9r+2nxONxEc+Hc7ouY=");
